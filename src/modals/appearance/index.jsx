          ...
          <section>
            ...
            <div className="bg-[color:var(--background-secondary)] p-4 rounded-2xl flex items-center gap-5">
              ...
              <div className="h-1 bg-[color:var(--color-secondary)] flex-1 rounded-full flex justify-between">
                {fontSizes.map((fs) => (
                  <button className="before:absolute before:inset-0 before:rounded-full before:hover:bg-[color:var(--color-primary)] before:opacity-10 w-8 h-8 rounded-full flex items-center justify-center relative -top-3.5 first:-ml-2 last:-mr-2">
                    <div className="w-3 h-3 rounded-full bg-[color:var(-color-secondary)]" />
                  </button>
                ))}
              </div>
          ...
          <section>
            ...
            <div className="py-2 px-4 mb-3 grid gap-2 grid-cols-3 bg-[color:var(--background-secondary)] rounded-2xl">
              ...
              <button
                ...
                className={classNames(
                  "h-16 pr-3 pl-2 bg-[#15202b] text-[#f7f9f9] border font-bold border-white/10  rounded group flex items-center gap-1.5",
                  {
                    "!border-[color:var(--color-primary)] !border-2 ":
