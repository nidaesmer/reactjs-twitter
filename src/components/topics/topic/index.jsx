  ...
  return (
    ...
    >
      ...
      <Popover className="absolute top-1.5 right-2 ">
        <Popover.Button className="outline-none w-[34.75px] h-[34.75px] rounded-full text-[#71767b]  flex items-center justify-center hover:bg-[#1d9bf01a] hover:text-[#1d9bf0] transition-colors  relative before:absolute before:inset-0 before:rounded-full before:transition-all before:z-[-1] before:opacity-[.15] z-[1]">
        ...
        <Popover.Panel className="w-[384px] rounded-xl grid  absolute top-2 overflow-hidden right-0 bg-black shadow-box z-[2]">
          <button
            type="button"
